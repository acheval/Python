...
# Sample String : "Python is better than anything else"
# Expected Result: 35



# 2. Write a Python program to sum all the items in a list.
# Sample list : [1,3,4,6,3,1,5,6, 1]
# Expected Result : 30
...
# 31. Write a Python function that takes two lists and returns True if they have at least one common member. Go
