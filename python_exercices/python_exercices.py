...
# 1. Write a Python program to calculate the length of a string.  Sample String
# : "Python is better than anything else" Expected Result: 35



# 2. Write a Python program to sum all the items in a list.  Sample list :
# [1,3,4,6,3,1,5,6, 1] Expected Result : 30



# 3. Write a Python program to multiplies all the items in a list.  Sample list
# : [1,2,3,4,5] Expected Result : 120


# 4. Write a Python program to get the largest number from a list.  Sample list
# : [1,2,4,63,3,7,4] Expected Result : 63


# 5. Write a Python program to get the smallest number from a list.  Sample list
# : [1,2,4,63,3,7,4] Expected Result : 1
...
# 9. Write a Python program to get a list, sorted in increasing order by the
# last element in each tuple from a given list of non-empty tuples.  Sample List
# : [(2, 5), (1, 2), (4, 4), (2, 3), (2, 1)] Expected Result : [(2, 1), (1, 2),
# (2, 3), (4, 4), (2, 5)]
...
# 14. Write a Python program to find the first appearance of the substring 'not'
# and 'poor' from a given string, if 'bad' follows the 'poor', replace the whole
# 'not'...'poor' substring with 'good'. Return the resulting string.  Sample
# String : 'The lyrics is not that poor!' Expected Result : 'The lyrics is
# good!'
...
# 29. Write a Python program to find the list of words that are longer than n
